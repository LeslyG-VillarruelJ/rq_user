...
import ec.edu.epn.rq_user.viewmodel.RutaViewModel

@Composable
fun CrearRutaScreen(navController: NavController, rutaViewModel: RutaViewModel = viewModel()) {
    ...
    Column(modifier = Modifier
        ...
        rutasCreadas.forEach { ruta ->
            RutaCard2(ruta = ruta, navController = navController)
        }
    }
}

@Composable
fun RutaCard2(ruta: Ruta, navController: NavController) {
    Card(
        modifier = Modifier
            ...
            .clickable {
                ...
                navController.navigate("ruta_detalle1/${ruta.nombre}")
            },
